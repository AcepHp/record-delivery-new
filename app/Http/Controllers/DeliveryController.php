...
class DeliveryController extends Controller
{
    ...
    try {
        $date = \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $validatedData['tgl_bln_thn']);
    } catch (\Exception $e) {
        $date = \Carbon\Carbon::createFromFormat('d-m-Y H:i:s', $validatedData['tgl_bln_thn']);
    }

    $validatedData['tgl_bln_thn'] = $date->format('Y-m-d H:i:s');
